...
#	},
	"banana_moggy" : {
		"name" : "Banana Hat",
		"description" : "The BANANA HAT. Or MAGIC MAN HAT...?",
	...
	"black_moggy" : {
		"name" : "Black Glasses",
		"description" : "Cool glasses. Makes Moggy look cool. Unlike this game",
	...
	"dream_moggy" : {
		"name" : "Dream Mask",
		"description" : "Good for speed runs",
	...
	"julliet_moggy" : {
		"name" : "Julliet Glasses",
		"description" : "Only brazilians would understand",
